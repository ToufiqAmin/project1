...
public class ModelUser {
	...
	@Column(name="ALL_INQUIRY_FLAG")
	private int allInquiryFlagStatus;
	...
	@Transient
	private String sAllInquiryFlag;
	...
	public int getAllInquiryFlagStatus() {
		return allInquiryFlagStatus;
	}

	public boolean isAllInquiryFlag() {
		return allInquiryFlag;
	}

	public String getsAllInquiryFlag() {
		return sAllInquiryFlag;
	}

	public void setAllInquiryFlagStatus(int allInquiryFlagStatus) {
		this.allInquiryFlagStatus = allInquiryFlagStatus;
	}

	public void setAllInquiryFlag(boolean allInquiryFlag) {
		this.allInquiryFlag = allInquiryFlag;
	}

	public void setsAllInquiryFlag(String sAllInquiryFlag) {
		this.sAllInquiryFlag = sAllInquiryFlag;
	}
	...
	public String toString() {
		return "ModelUser [userId=" + userId + ", userName=" + userName + ", userDesignationId=" + userDesignationId
				...
				+ ", branchUnitId=" + branchUnitId + ", dob=" + dob + ", genderStatus=" + genderStatus + ", bloodGroup="
				...
				+ userRemarks + ", orgTypeRemarks=" + orgTypeRemarks + ", entryTimestamp=" + entryTimestamp
				+ ", enteredBy=" + enteredBy + ", updatedBy=" + updatedBy + ", updateTimestap=" + updateTimestap
				+ ", flex1=" + flex1 + ", flex2=" + flex2 + ", flex3=" + flex3 + ", flex4=" + flex4 + ", flex5=" + flex5
				+ ", passportNo=" + passportNo + ", allInquiryFlagStatus=" + allInquiryFlagStatus + ", active=" + active
				+ ", sActive=" + sActive + ", gender=" + gender + ", sGender=" + sGender + ", allInquiryFlag="
				+ allInquiryFlag + ", sAllInquiryFlag=" + sAllInquiryFlag + "]";
	}
