...
@Controller
public class TermsconListController {
...
private Long systemUserId;
	 ...
	 @RequestMapping(path = "/termscon/list/{userId}", method = RequestMethod.GET)
	    public String getTermscon(@PathVariable Long userId,Model model) {
	     ...
	     return "termscon_list";

	}
	 
	 
	 @RequestMapping(path="/termscon/search")
		public String getTermsconList(Model model,@RequestParam("typeName")String typeName
		  ...
		  System.out.println("system user :" + systemUserId);
			...
			model.addAttribute("typeList",termsconRepository.findTermsconDetails(typeName, remarks, status));	
