...
private Long systemUserId;
	...
	@RequestMapping(path = "/clustercontroller/list/{userId}", method = RequestMethod.GET)
	...
	@RequestMapping(path="/clustercontroller/getclusterlist")
	public String getClusterList(Model model,@RequestParam("clusterName")String clusterName,@RequestParam("shortCode")String shortCode
...
// left panel list
	...
	//left panel list
		...
		model.addAttribute("clusterList",daoCluster.getClusterListByCraiteria(clusterName, shortCode, remarks, status));	
		return "clusterList";
	}
