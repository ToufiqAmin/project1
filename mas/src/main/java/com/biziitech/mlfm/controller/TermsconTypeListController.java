...
@Controller
public class TermsconTypeListController {
...
private Long systemUserId;
	...
	@RequestMapping(path = "/termscontype/list/{userId}", method = RequestMethod.GET)
    public String getTermsconTypeList(@PathVariable Long userId,Model model) {
        ...
        return "termscon_type_list";
   }
	
	@RequestMapping(path="/termscontype/search")
	public String getTermsconTypeList(Model model,@RequestParam("typeName")String typeName,@RequestParam("shortCode")String shortCode
		...
		model.addAttribute("typeList",termsconTypeRepository.findTypeDetails(typeName, shortCode, remarks, status));	
