...
@Controller
public class PITypeListController {
...
private Long systemUserId;
	...
	@RequestMapping(path = "/pitype/list/{userId}", method = RequestMethod.GET)
    public String getPITypeList(@PathVariable Long userId,Model model) {
	...
	@RequestMapping(path="/pitype/search")
	public String getTypeList(Model model,@RequestParam("typeName")String typeName,@RequestParam("shortCode")String shortCode
		...
		model.addAttribute("typeList",pITypeRepository.findTypeDetails(typeName, shortCode, remarks, status));	
		return "pitype_list";
	}
