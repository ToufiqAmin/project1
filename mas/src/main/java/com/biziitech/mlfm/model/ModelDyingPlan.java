...
@Entity(name="MLFM_DYING_PLAN")
public class ModelDyingPlan {

	@Id @GenericGenerator(name = "custom_sequence", strategy = 
			"com.biziitech.mlfm.IdGenerator")
	@GeneratedValue(generator = "custom_sequence")
	@Column(name="DYING_PLAN_ID")
	private Long dyingPlanId;
	
	@DateTimeFormat(pattern = "yyyy-MM-dd")
	@Column(name="DYING_PLAN_DATE")
	...
	public String toString() {
		return "ModelDyingPlan [dyingPlanId=" + dyingPlanId + ", dyingPlanDate=" + dyingPlanDate + ", modelPOMst="
				+ modelPOMst + ", dyingPlanQty=" + dyingPlanQty + ", dyingPlanRemarks=" + dyingPlanRemarks
				...
				+ ", flex2=" + flex2 + ", flex3=" + flex3 + ", flex4=" + flex4 + ", flex5=" + flex5 + ", modelUOM="
				+ modelUOM + ", active=" + active + ", sActive=" + sActive + "]";
	}
