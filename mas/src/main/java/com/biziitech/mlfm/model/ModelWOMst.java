...
@Entity(name="MLFM_WO_MST")



public class ModelWOMst {
	
	@Id @GenericGenerator(name = "custom_sequence", strategy = 
			"com.biziitech.mlfm.IdGenerator")
	@GeneratedValue(generator = "custom_sequence")
	@Column(name="WO_MST_ID")
	...
	public String toString() {
		return "ModelWOMst [wOMstId=" + wOMstId + ", wODate=" + wODate + ", userWONo=" + userWONo + ", modelOrderOwner="
				+ modelOrderOwner + ", remarks=" + remarks + ", activeStatus=" + activeStatus + ", enteredBy="
				+ enteredBy + ", updatedBy=" + updatedBy + ", entryTimestamp=" + entryTimestamp + ", updateTimestap="
