...
@Entity(name="MLFM_MACHINE_TYPE")
public class ModelMachineType {
	...
	public String toString() {
		return "ModelMachineType [machineTypeId=" + machineTypeId + ", machineTypeName=" + machineTypeName
