...
@Entity(name="MLFM_PI_TYPE")
public class ModelPIType {
	...
	public void setPITypeId(Long pITypeId) {
		PITypeId = pITypeId;
	}
	...
	public String toString() {
		return "ModelPIType [PITypeId=" + PITypeId + ", typeName=" + typeName + ", shortCode=" + shortCode
