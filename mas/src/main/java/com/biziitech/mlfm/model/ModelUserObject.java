...
//	private ModelRole modelRole;
	...
	public void setModelBranch(ModelBranch modelBranch) {
	...
	public String toString() {
		return "ModelUserObject [userObjectId=" + userObjectId + ", modelUser=" + modelUser + ", modelObject="
				+ modelObject + ", modelBranch=" + modelBranch + ", remarks=" + remarks + ", activeStatus="
				+ activeStatus + ", enteredBy=" + enteredBy + ", updatedBy=" + updatedBy + ", entryTimestamp="
				+ entryTimestamp + ", updateTimestap=" + updateTimestap + ", flex1=" + flex1 + ", flex2=" + flex2
