...
public class ModelItem {
	...
	public String toString() {
		return "ModelItem [itemId=" + itemId + ", itemTypeId=" + itemTypeId + ", modelUOM=" + modelUOM + ", itemName="
				+ itemName + ", itemSpec=" + itemSpec + ", remarks=" + remarks + ", activeStatus=" + activeStatus
				...
				+ ", categoryId=" + categoryId + ", subcategoryId=" + subcategoryId + ", subsubcategoryId="
				+ subsubcategoryId + "]";
	}
